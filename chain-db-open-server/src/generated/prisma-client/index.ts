...
export interface Exists {
  ...
  dAOProject: (where?: DAOProjectWhereInput) => Promise<boolean>;
...
export interface Prisma {
  ...
  dAOProject: (where: DAOProjectWhereUniqueInput) => DAOProjectNullablePromise;
  dAOProjects: (args?: {
    where?: DAOProjectWhereInput;
    orderBy?: DAOProjectOrderByInput;
    skip?: Int;
    after?: String;
    before?: String;
    first?: Int;
    last?: Int;
  }) => FragmentableArray<DAOProject>;
  dAOProjectsConnection: (args?: {
    where?: DAOProjectWhereInput;
    orderBy?: DAOProjectOrderByInput;
    skip?: Int;
    after?: String;
  ...
  createDAOProject: (data: DAOProjectCreateInput) => DAOProjectPromise;
  updateDAOProject: (args: {
    data: DAOProjectUpdateInput;
    where: DAOProjectWhereUniqueInput;
  }) => DAOProjectPromise;
  updateManyDAOProjects: (args: {
    data: DAOProjectUpdateManyMutationInput;
    where?: DAOProjectWhereInput;
  }) => BatchPayloadPromise;
  upsertDAOProject: (args: {
    where: DAOProjectWhereUniqueInput;
    create: DAOProjectCreateInput;
    update: DAOProjectUpdateInput;
  }) => DAOProjectPromise;
  deleteDAOProject: (where: DAOProjectWhereUniqueInput) => DAOProjectPromise;
  deleteManyDAOProjects: (where?: DAOProjectWhereInput) => BatchPayloadPromise;
...
export interface Subscription {
  ...
  dAOProject: (
    where?: DAOProjectSubscriptionWhereInput
...
export type DAOProjectOrderByInput =
  | "id_ASC"
  | "id_DESC"
  | "projectId_ASC"
  | "projectId_DESC";
...
export type DAOProjectWhereUniqueInput = AtLeastOne<{
  id: Maybe<ID_Input>;
  projectId?: Maybe<Int>;
}>;

export interface DAOProjectWhereInput {
  id?: Maybe<ID_Input>;
  id_not?: Maybe<ID_Input>;
  id_in?: Maybe<ID_Input[] | ID_Input>;
  id_not_in?: Maybe<ID_Input[] | ID_Input>;
  ...
  AND?: Maybe<DAOProjectWhereInput[] | DAOProjectWhereInput>;
  OR?: Maybe<DAOProjectWhereInput[] | DAOProjectWhereInput>;
  NOT?: Maybe<DAOProjectWhereInput[] | DAOProjectWhereInput>;
}
...
export interface DAOProjectCreateInput {
  id?: Maybe<ID_Input>;
  projectId: Int;
}

export interface DAOProjectUpdateInput {
  projectId?: Maybe<Int>;
}

export interface DAOProjectUpdateManyMutationInput {
  projectId?: Maybe<Int>;
}
...
export interface DAOProjectSubscriptionWhereInput {
  mutation_in?: Maybe<MutationType[] | MutationType>;
  updatedFields_contains?: Maybe<String>;
  updatedFields_contains_every?: Maybe<String[] | String>;
  updatedFields_contains_some?: Maybe<String[] | String>;
  node?: Maybe<DAOProjectWhereInput>;
  AND?: Maybe<
    DAOProjectSubscriptionWhereInput[] | DAOProjectSubscriptionWhereInput
  >;
  OR?: Maybe<
    DAOProjectSubscriptionWhereInput[] | DAOProjectSubscriptionWhereInput
  >;
...
export interface DAOProjectPromise extends Promise<DAOProject>, Fragmentable {
  id: () => Promise<ID_Output>;
  projectId: () => Promise<Int>;
}

export interface DAOProjectSubscription
  extends Promise<AsyncIterator<DAOProject>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
  projectId: () => Promise<AsyncIterator<Int>>;
}

export interface DAOProjectNullablePromise
  extends Promise<DAOProject | null>,
    Fragmentable {
  id: () => Promise<ID_Output>;
  projectId: () => Promise<Int>;
}

export interface DAOProjectConnection {
  pageInfo: PageInfo;
  edges: DAOProjectEdge[];
}

export interface DAOProjectConnectionPromise
  extends Promise<DAOProjectConnection>,
    Fragmentable {
  pageInfo: <T = PageInfoPromise>() => T;
  edges: <T = FragmentableArray<DAOProjectEdge>>() => T;
  aggregate: <T = AggregateDAOProjectPromise>() => T;
}

export interface DAOProjectConnectionSubscription
  extends Promise<AsyncIterator<DAOProjectConnection>>,
    Fragmentable {
  pageInfo: <T = PageInfoSubscription>() => T;
  edges: <T = Promise<AsyncIterator<DAOProjectEdgeSubscription>>>() => T;
  aggregate: <T = AggregateDAOProjectSubscription>() => T;
}

export interface DAOProjectEdge {
  node: DAOProject;
  cursor: String;
}

export interface DAOProjectEdgePromise
  extends Promise<DAOProjectEdge>,
    Fragmentable {
  node: <T = DAOProjectPromise>() => T;
  cursor: () => Promise<String>;
}

export interface DAOProjectEdgeSubscription
  extends Promise<AsyncIterator<DAOProjectEdge>>,
    Fragmentable {
  node: <T = DAOProjectSubscription>() => T;
  cursor: () => Promise<AsyncIterator<String>>;
}

export interface AggregateDAOProject {
  count: Int;
}

export interface AggregateDAOProjectPromise
  extends Promise<AggregateDAOProject>,
    Fragmentable {
  count: () => Promise<Int>;
}

export interface AggregateDAOProjectSubscription
  extends Promise<AsyncIterator<AggregateDAOProject>>,
    Fragmentable {
  count: () => Promise<AsyncIterator<Int>>;
}
...
export interface DAOProjectSubscriptionPayload {
  mutation: MutationType;
  node: DAOProject;
  updatedFields: String[];
  previousValues: DAOProjectPreviousValues;
}

export interface DAOProjectSubscriptionPayloadPromise
  extends Promise<DAOProjectSubscriptionPayload>,
    Fragmentable {
  mutation: () => Promise<MutationType>;
  node: <T = DAOProjectPromise>() => T;
  updatedFields: () => Promise<String[]>;
  previousValues: <T = DAOProjectPreviousValuesPromise>() => T;
}

export interface DAOProjectSubscriptionPayloadSubscription
  extends Promise<AsyncIterator<DAOProjectSubscriptionPayload>>,
    Fragmentable {
  mutation: () => Promise<AsyncIterator<MutationType>>;
  node: <T = DAOProjectSubscription>() => T;
  updatedFields: () => Promise<AsyncIterator<String[]>>;
  previousValues: <T = DAOProjectPreviousValuesSubscription>() => T;
}

export interface DAOProjectPreviousValues {
  id: ID_Output;
  projectId: Int;
}

export interface DAOProjectPreviousValuesPromise
  extends Promise<DAOProjectPreviousValues>,
    Fragmentable {
  id: () => Promise<ID_Output>;
  projectId: () => Promise<Int>;
}

export interface DAOProjectPreviousValuesSubscription
  extends Promise<AsyncIterator<DAOProjectPreviousValues>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
  projectId: () => Promise<AsyncIterator<Int>>;
}
