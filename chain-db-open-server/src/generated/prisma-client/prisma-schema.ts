...
type DAOProjectConnection {
  pageInfo: PageInfo!
  edges: [DAOProjectEdge]!
  aggregate: AggregateDAOProject!
}

input DAOProjectCreateInput {
  id: ID
  projectId: Int!
}
...
type DAOProjectPreviousValues {
  id: ID!
  projectId: Int!
}

type DAOProjectSubscriptionPayload {
  mutation: MutationType!
  node: DAOProject
  updatedFields: [String!]
...
input DAOProjectSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: DAOProjectWhereInput
  AND: [DAOProjectSubscriptionWhereInput!]
  OR: [DAOProjectSubscriptionWhereInput!]
  NOT: [DAOProjectSubscriptionWhereInput!]
}

input DAOProjectUpdateInput {
  projectId: Int
}

input DAOProjectUpdateManyMutationInput {
  projectId: Int
}

input DAOProjectWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  projectId_gt: Int
  projectId_gte: Int
  AND: [DAOProjectWhereInput!]
  OR: [DAOProjectWhereInput!]
  NOT: [DAOProjectWhereInput!]
}

input DAOProjectWhereUniqueInput {
  id: ID
  projectId: Int
}
...
type Mutation {
  ...
  createDAOProject(data: DAOProjectCreateInput!): DAOProject!
  updateDAOProject(data: DAOProjectUpdateInput!, where: DAOProjectWhereUniqueInput!): DAOProject
  updateManyDAOProjects(data: DAOProjectUpdateManyMutationInput!, where: DAOProjectWhereInput): BatchPayload!
  upsertDAOProject(where: DAOProjectWhereUniqueInput!, create: DAOProjectCreateInput!, update: DAOProjectUpdateInput!): DAOProject!
  deleteDAOProject(where: DAOProjectWhereUniqueInput!): DAOProject
  deleteManyDAOProjects(where: DAOProjectWhereInput): BatchPayload!
...
type Query {
  ...
  dAOProject(where: DAOProjectWhereUniqueInput!): DAOProject
  dAOProjects(where: DAOProjectWhereInput, orderBy: DAOProjectOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [DAOProject]!
  dAOProjectsConnection(where: DAOProjectWhereInput, orderBy: DAOProjectOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): DAOProjectConnection!
...
type Subscription {
  ...
  dAOProject(where: DAOProjectSubscriptionWhereInput): DAOProjectSubscriptionPayload
